...
func openUrlNoHeader(ctx context.Context, url string) (io.ReadCloser, error) {
...
func openUrlAsString(ctx context.Context, url string) (string, error) {
	body, requestErr := openUrlNoHeader(ctx, url)
...
func fetch(url *U.URL, file string) (fetchHeader, error) {
	...
	return header, writeFileWithContext(file, reader, ctx, url)
}
...
func writeFileWithContext(file string, reader io.Reader, ctx context.Context, url *U.URL) error {
